...
<script>
    ...
    window.viewProduct = (order_number, customer_name, order_status) => {
        new GetRequest({
            getUrl: "controller/courier/order?action=get-orders",
            params: {
    ...
    function trackOrder(trackingNumber) {
        new GetRequest({
            getUrl: "controller/courier/order?action=track-order",
            params: {
    ...
    function getOrderDetails(orderNumber) {
        new GetRequest({
            getUrl: "controller/courier/order?action=get-order-details",
            params: {
